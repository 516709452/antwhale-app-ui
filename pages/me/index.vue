<template>
  <view class="mine-container" :style="{height: `${windowHeight}px`}">
   ...
   <!--  <view class="mine-actions grid col-4 text-center">
	  ...
	  <view>
      <view class="menu-list mine-actions grid">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      handleToEditInfo() {
        this.$tab.navigateTo('/pages/me/info/edit')
      },
      handleToSetting() {
        this.$tab.navigateTo('/pages/me/setting/index')
      },
      handleToLogin() {
      ...
      handleLogout() {
        this.$modal.confirm('确定注销并退出系统吗？').then(() => {
          this.$store.dispatch('LogOut').then((res) => {
            ...
            this.$tab.reLaunch('/pages/login').then(()=>{this.$modal.msgSuccess(res.data)})
          })
        })
      },
      handleHelp() {
